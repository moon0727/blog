...
![GitHub Template으로 Repository 생성](/Blog/images/clone-quartz.png)
...
![Obsidian 보관함 폴더 열기](/Blog/images/obsidian-vault.png)

2. Quartz 프로젝트의 `content` 폴더 선택

![Content 폴더 선택](/Blog/images/obsidian-content.png)
...
![Cloudflare Pages 시작](/Blog/images/cloudflare-pages.png)

2. **Connect to Git**에서 GitHub repository 연결

![GitHub Repository 연결](/Blog/images/cloudflare-github.png)

3. 빌드 설정 입력

![빌드 설정](/Blog/images/cloudflare-build.png)
...
![배포 완료](/Blog/images/deployment-success.png)
